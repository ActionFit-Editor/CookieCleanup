...
- Repository: `https://github.com/ActionFitGames/CookieCleanup.git`
...
Keep the package code-only and project-neutral. Do not reference `Assembly-CSharp`, Cat Merge generated table types, Addressables, analytics SDKs, UGUI, DOTween, project persistence APIs, prefabs, or assets.
...
- New events use UTC ticks and an explicit UTC+09:00 service calendar. Imported active local ticks remain numeric local ticks until that event ends.
...
Run package tests, package contract validation, isolated Unity validation, project compilation, AI docs validation, and a serialized diff audit before handoff. Repository creation, tagging, publishing, catalog append, deployment, and asset migration require separate approval.
